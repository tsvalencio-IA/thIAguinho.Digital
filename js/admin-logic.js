...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- FORMATADOR DE CÓDIGO COM PREVIEW E DOWNLOAD ---
    ...
    window.baixarCodigo = function(blockId, extensao) {
        ...
        a.href = url;
        a.download = `sistema_demo.${extensao}`;
    ...
    // --- LEITURA DA BASE DE DADOS E CARTÕES RÍGIDOS ---
    ...
    function renderizarProjetos() {
        ...
        projetosFiltrados.forEach(cliente => {
            ...
            // Shrink-0 previne o sumiço dos cards
    ...
    window.abrirModalProjeto = function(id) {
        try {
            ...
            if(chatDisplay) {
                chatDisplay.innerHTML = `<div class="msg-dev ai">Olá, Thiago! Estou pronto para codificar. O sistema que você me pedir já será programado com um <b>Bloqueio de 5 Cliques</b> automático para demonstração.</div>`;
